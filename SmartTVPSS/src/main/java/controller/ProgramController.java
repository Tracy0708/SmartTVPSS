...
public class ProgramController {
	...
	@ResponseBody
	public ResponseEntity<?> saveTimeline(@RequestParam("schoolId") Integer schoolId,
			@RequestParam("timelineStart") String timelineStart, @RequestParam("timelineEnd") String timelineEnd) {
	...
	public String updateAdminSchool(@RequestParam("id") Integer id, @ModelAttribute School school,
			RedirectAttributes redirectAttributes) {
		try {
			school.setId(id);
			schoolDao.update(id, school);
			redirectAttributes.addFlashAttribute("successMessage", "School information has been updated successfully!");
			return "redirect:/program/admin/edit/";
		} catch (Exception e) {
	...
	@RequestMapping("/tvpssteam/reportList")
