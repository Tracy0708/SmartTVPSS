...
<body>
    ...
    <div class="content">
    	<div class="detail-header">
           	<a href="activityList"><svg xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px" fill="black">
               	<path d="m313-440 224 224-57 56-320-320 320-320 57 56-224 224h487v80H313Z" />
            </svg></a>
        <h2 style="padding-left: 20px;">Activity History</h2>
        </div>
        ...
        <div class="pagination">
            <c:if test="${currentPage > 1}">
                <a href="history?page=${currentPage - 1}&search=${param.search}&type=${param.type}&level=${param.level}">Previous</a>
            </c:if>
        
            <c:forEach begin="1" end="${totalPages}" var="pageNo">
                <a href="history?page=${pageNo}&search=${param.search}&type=${param.type}&level=${param.level}" 
            ...
            <c:if test="${currentPage < totalPages}">
                <a href="history?page=${currentPage + 1}&search=${param.search}&type=${param.type}&level=${param.level}">Next</a>
            </c:if>
        </div>
	                ...
	                <c:forEach var="activity" items="${activities}">
	                    <tr>
	                        ...
	                        <td>
					            ...
					            <a href="viewParticipant?id=${activity.id}" class="btn btn-primary btn-sm me-2">Participant</a>
	                        </td>
	                    </tr>
	                </c:forEach>
                </tbody>
