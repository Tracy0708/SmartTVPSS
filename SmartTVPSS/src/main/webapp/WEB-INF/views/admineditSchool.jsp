...
/* $(document).ready(function() {
    $('#updateForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/program/admin/updateSchool',
            type: 'POST',
            data: $(this).serialize(),
            success: function(response) {
                Swal.fire({
                    title: 'Success!',
                    text: 'School information has been updated successfully!',
                    icon: 'success',
                    confirmButtonText: 'OK'
                });
            },
            error: function(xhr) {
                Swal.fire({
                    title: 'Error!',
                    text: xhr.responseText || 'An error occurred while updating the school.',
                    icon: 'error',
                    confirmButtonText: 'OK'
                });
            }
...
<div class="main-container" style="display:flex">
    ...
    <input type="hidden" name="id" value="${school.id}"/>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="schoolCode" class="form-control" value="${school.schoolCode}" required readonly>
                </div>

                <div class="form-group">
                    <label class="form-label required">School Name</label>
                    <input type="text" name="schoolName" class="form-control" value="${school.schoolName}" required readonly >
                </div>
