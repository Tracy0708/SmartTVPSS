	...
	<div class="main-container" style="display: flex">
		...
		<div class="container">
			...
			<div class="button-group">
				<a href="${pageContext.request.contextPath}/program/tvpssteam/add"
					class="btn btn-primary">Add School</a> <a
					href="${pageContext.request.contextPath}/program/tvpssteam/timeline"
					class="btn btn-primary">Set Timeline</a>
			</div>
							...
							<c:forEach items="${schoolList}" var="school" varStatus="status">
								<tr>
									...
									<td class="action-buttons"><a
										href="${pageContext.request.contextPath}/program/tvpssteam/edit/${school.id}"
										class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
										<a href="#" onclick="confirmDelete(${school.id})"
			...
			<a
				href="${pageContext.request.contextPath}/program/tvpssteam/reportList"
				class="view-report-link">View schools' version report</a>
		</div>
	</div>
	<script>
